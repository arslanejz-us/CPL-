          ...
          <section className="pt-16 lg:pt-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-medium text-black mb-4">Types of Custom Mailer Boxes</h2>
                <p className="text-base font-normal text-[#575757] max-w-2xl mx-auto">Explore our complete range of custom mailer boxes for every shipping need.</p>
              </div>
