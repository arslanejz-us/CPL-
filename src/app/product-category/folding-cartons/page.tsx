          ...
          <section className="pt-16 lg:pt-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-medium text-black mb-4">Types of Folding Cartons</h2>
                <p className="text-base font-normal text-[#575757] max-w-2xl mx-auto">Complete range of folding cartons for any industry and application.</p>
              </div>
