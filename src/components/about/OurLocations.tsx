  ...
  return (
    <section className="relative py-14 lg:py-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-9 justify-items-center">
          {LOCATIONS.map((location) => (
            <div
              key={location.title}
              className="w-full max-w-[334px] h-[450px] bg-[#F7F7F7] rounded-[12px] border border-[#e8e8e8] flex flex-col overflow-hidden"
            >
              {/* Single building image per card */}
              <div className="relative mx-3 mt-3 h-[170px] rounded-[10px] overflow-hidden shrink-0 bg-[#F7F7F7]">
                <Image
                  src={location.image}
                  alt={location.title}
                  fill
              ...
              <div className="flex flex-col items-center text-center flex-1 px-4 pt-5 pb-6">
                <div className="flex items-center justify-center w-[55px] h-[55px] rounded-full border-[2.5px] border-[#00756e] text-[#00756e] shrink-0">
                  <location.Icon className="w-6 h-6" strokeWidth={1.5} />
                </div>

                <div className="w-4 h-[1.5px] bg-[#00756e]/40 mt-2" />

                <h3 className="text-[16px] font-bold font-montserrat text-[#00756e] mt-3 leading-none">
                  {location.title}
                </h3>

                <address className="not-italic text-[12px] text-[#63625d] leading-5 mt-2">
