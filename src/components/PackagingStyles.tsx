...
export default function PackagingStyles() {
  ...
  return (
    <section className="bg-white py-20" id="styles">
        ...
        <div className="relative">
          ...
          >
            {STYLES.map(({ name, image }) => (
              ...
              >
                <div className="relative h-64 w-full rounded-2xl border border-gray-100 group-hover:shadow-lg transition-shadow p-4 bg-gray-50 flex items-center justify-center overflow-hidden">
