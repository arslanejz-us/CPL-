...
<head>
    ...
    <title>Rigid Boxes | Custom Packaging Lane</title>
    ...
    <div class="site-wrapper">
        ...
        <main class="main-content">
            <section style="padding: 4rem 1rem; background: linear-gradient(135deg, #137B74, #009688); color: white;">
                <div class="max-width">
                    <h1 style="color: white;">Premium Rigid Boxes</h1>
                    <p style="font-size: 1.125rem; color: rgba(255,255,255,0.9);">Luxury packaging for premium products and high-end brands</p>
                </div>
            </section>
                ...
                <div class="max-width">
                    <div style="text-align: center;">
                        <p style="color: #666; line-height: 1.8; max-width: 700px; margin: 0 auto;">
                            Our rigid boxes are the ultimate choice for luxury goods, premium products, and brands that demand perfection. With superior durability and customizable designs, they create an unforgettable unboxing experience.
                        </p>
